...
import com.test.notice.BoardDAO;
import com.test.notice.BoardDTO;

@WebServlet("/ground/ground.do")
public class Ground extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//목록 or 검색
				...
				ArrayList<GroundDTO> list = dao.list(map);
				...
				if(n==1) {
					...
					pagebar += "<li>";
					pagebar += String.format("<a href=\"/soccer/ground/ground.do?page=%d\" aria-label=\"Previous\">", n - 1);
					pagebar += "<span aria-hidden=\"true\">&laquo;</span>";
					pagebar += "</a>";
					pagebar += "</li>";
				}
				...
				while (!(loop > blockSize || n > totalPage)) {
					...
					if (n == nowPage) {
						...
						pagebar += "<li>";
						pagebar += String.format("<a href=\"/soccer/ground/ground.do?page=%d\">%d</a>", n, n);
						pagebar += "</li>";
					}
				...
				if (n > totalPage) {
					...
					pagebar += "<li>";
					pagebar += String.format("<a href=\"/soccer/ground/ground.do?page=%d\" aria-label=\"Next\">", n);
					pagebar += "<span aria-hidden=\"true\">&raquo;</span>";
					pagebar += "</a>";
					pagebar += "</li>";
				}
...
//				req.setAttribute("sort", sort);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/ground/ground.jsp");
