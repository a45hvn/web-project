		...
		<div class="container">
				...
				<ul class="people">
					...
					<li class="person" data-chat="person3"><img
						...
						alt="" /> <span class="name">Louis CK</span> <span class="time">2:09
							PM</span> <span class="preview">But we’re probably gonna need a
							new carpet.</span></li>
					<li class="person" data-chat="person4"><img
						...
						alt="" /> <span class="name">Bo Jackson</span> <span class="time">2:09
							PM</span> <span class="preview">It’s not that bad...</span></li>
			...
			<div class="right">
				...
				<div class="chat" data-chat="person3">
					...
					<div class="bubble you">But we’re probably gonna need a new
						carpet.</div>
				</div>
