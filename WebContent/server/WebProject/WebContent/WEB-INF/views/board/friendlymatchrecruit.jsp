        ...
        <div id="centerMainBox">
            ...
            <div id="centerbox2">
                <table class="table table-bordered table-striped" id="verticalTable">
                    ...
                    <tr>
                        <td>1</td>
                        <td><a href="friendlymatchcontents.html">7월 18일 친선경기 할 팀 모집 합니다.</a></td>
                        <td>오희준</td>
                    ...
                    <tr>
                        <td>2</td>
                        <td><a href="friendlymatchcontents.html">7월 25일 친선경기 할 팀 모집 합니다.</a></td>
                        <td>오희준</td>
                        <td>2020.07.14 17:48</td>
                        <td>15</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td><a href="friendlymatchcontents.html">7월 26일 친선경기 할 팀 모집 합니다.</a></td>
                        <td>오희준</td>
                        <td>2020.07.14 17:48</td>
                        <td>15</td>
                    </tr>
