...
이 약관은 나는 축구왕이 운영하는 웹사이트(www.shbaseball.co..kr)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 합니다)를 시흥시야구협회 계정(이하 “시흥시야구협회 계정”이라 합니다)으로 가입하여 이용함에 있어 시흥시야구협회와 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
            
            제 ２ 조 (정의)
            
            1. [시흥시야구협회 (www.shbaseball.co..kr)]이란 [협회]가 재화 또는 용역(이하 “재화 등”이라 합니다)을 이용자에게 제공하기 위하여 컴퓨터 등 정보 통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며 아울러 [시흥시야구협회, 시흥시야구협회 웹사이트]를 운영하는 사업자의 의미로도 사용합니다.
...
이 약관은 시흥시야구협회(이하 “협회”라 합니다)가 운영하는 시흥시야구협회 웹사이트(www.shbaseball.co..kr)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 합니다)를 시흥시야구협회 계정(이하 “시흥시야구협회 계정”이라 합니다)으로 가입하여 이용함에 있어 시흥시야구협회와 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
