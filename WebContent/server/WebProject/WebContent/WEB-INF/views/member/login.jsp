	...
	<form method="POST" action="/soccer/member/loginok.do">
     <div class="loginBox">
        ...
        <div class="loginInput">
            <input type="text" class="id required form-control" id="id" name="id" title="아이디" placeholder="아이디">
            <input type="password" class="pw required form-control" id="pw" name="pw" title="비밀번호"  placeholder="비밀번호">
