        ...
        <table class="table table-default" id="mainMenu">
            <tr id="menuTop">
                ...
                <td colspan="4">
					...
					<span></span> 
					<span>
						<span class="toppackage" style="border-bottom: 1px solid silver; margin-right: 20px;">${name} 님</span>
						<span class="glyphicon glyphicon-ok toppackage"></span> 
            ...
            <tr id="menuTr">
                ...
                <td class="menu menu7"><span class="menuLabel"><a href="/soccer/board/clubmanagementEntrylistDrawup.do">공지사항</a></span></td>
            </tr>
        </table>
 </nav>
<!-- 상단부 끝-->